...
import { Power, UserCircle, Files, Database, Keyboard, RefreshCw, KeyRound, LogOut } from 'lucide-react';
        ...
        <div className="flex items-center gap-3 relative z-10">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1.5 mt-0.5">
              <div className={`w-1.5 h-1.5 rounded-full ${enabled ? 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]' : 'bg-rose-500'}`} />
      ...
      <div className="px-3 flex flex-col gap-2.5">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-3 shadow-sm flex items-center justify-between group hover:border-indigo-100 transition-colors">
          <div className="flex items-center gap-2.5">
            <div className={`p-1.5 rounded-xl transition-colors ${enabled ? 'bg-indigo-50 text-indigo-600' : 'bg-gray-50 text-gray-500'}`}>
              <Power size={16} strokeWidth={2} />
            </div>
            <div>
              <p className="text-sm font-semibold text-gray-900 leading-none mb-0.5">Auto-Fill Engine</p>
        ...
        <div className="grid grid-cols-2 gap-2.5">
          <div className="bg-white rounded-2xl border border-gray-100 p-3 shadow-sm flex flex-col hover:border-purple-100 transition-colors group">
            <div className="flex items-center gap-1.5 mb-1 text-gray-400 group-hover:text-purple-500 transition-colors">
              ...
              <span className="text-[10px] font-bold uppercase tracking-wider text-gray-500">Data Points</span>
            </div>
           ...
           <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-1">
                <kbd className="px-1.5 py-0.5 min-w-[20px] text-center bg-gray-50 border border-gray-200 rounded text-[10px] font-mono text-gray-600 shadow-sm">Ctrl</kbd>
                <kbd className="px-1.5 py-0.5 min-w-[20px] text-center bg-gray-50 border border-gray-200 rounded text-[10px] font-mono text-gray-600 shadow-sm">Shift</kbd>
                <kbd className="px-1.5 py-0.5 min-w-[20px] text-center bg-gray-50 border border-gray-200 rounded text-[10px] font-mono text-gray-600 shadow-sm transition-colors text-indigo-600 border-indigo-100 bg-indigo-50">F</kbd>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-1">
                <kbd className="px-1.5 py-0.5 min-w-[20px] text-center bg-gray-50 border border-gray-200 rounded text-[10px] font-mono text-gray-600 shadow-sm">Ctrl</kbd>
                <kbd className="px-1.5 py-0.5 min-w-[20px] text-center bg-gray-50 border border-gray-200 rounded text-[10px] font-mono text-gray-600 shadow-sm">Shift</kbd>
                <kbd className="px-1.5 py-0.5 min-w-[20px] text-center bg-gray-50 border border-gray-200 rounded text-[10px] font-mono text-gray-600 shadow-sm">R</kbd>
              </div>
            </div>
